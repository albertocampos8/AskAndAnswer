    ...
    public class CustomCode
    {
        ...
        public static void ConstructInputControls(SqlDataReader dR, System.Web.UI.Control cntlContainer, int displayType = -1)
        {
            ...
            while (dR.Read())
            {
                ...
                //We want the group of controls generated by this database record to be enclosed in a div, to simplify toggling
                //their visibility
                //string qVisible = "";
                ...
                //System.Web.UI.Control containingDiv = new LiteralControl("<div " + qID + qVisible + "></div>");
                //Add this containingDiv to the cntlContainer
                //cntlContainer.Controls.Add(containingDiv);



                //...and now add controls to the containingDiv
